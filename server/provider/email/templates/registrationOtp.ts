export default function RegistrationOtpTemplate(otp: string) {
               ...
               <table cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse">
                 <tr>
                  <td align="center" valign="top" style="padding:0;margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse">
                     <tr>
                      <td align="center" style="margin:0;padding:15px 40px"><h1 style="margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:40px;font-weight:bold;line-height:48px;color:#333333">Verify Your Email</h1></td>
                     </tr>
                     <tr>
                      <td align="center" style="padding:10px 0 0 0;margin:0"><p style="margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">Use the following code to verify your email and complete your registration:</p></td>
                     </tr>
                     <tr>
                 ...
                 <tr>
                  <td align="center" valign="top" style="padding:0;margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;border-radius:5px">
                     ...
                     <tr>
                      <td align="center" style="padding:10px 0;margin:0"><p style="margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">If you didn't request this code, please ignore this email.</p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
