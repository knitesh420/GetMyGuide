export default function AdminOtpTemplate(otp: string) {
                 ...
                 <tr>
                  <td align="center" valign="top" style="padding:0;margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse">
                     ...
                     <tr>
                      <td align="center" style="margin:0;padding:15px 40px"><h1 style="margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:46px;font-weight:bold;line-height:55px;color:#333333">Admin Login</h1></td>
                     </tr>
                     <tr>
                      <td align="center" style="padding:10px 0 0 0;margin:0"><p style="margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">Use the following one-time password to log in to your admin dashboard:</p></td>
                     </tr>
                     <tr>
                 ...
                 <tr>
                  <td align="center" valign="top" style="padding:0;margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;border-radius:5px">
                     ...
                     <tr>
                      <td align="center" style="padding:10px 0;margin:0"><p style="margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">If you didn't request this code, please ignore this email or contact support immediately.</p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
