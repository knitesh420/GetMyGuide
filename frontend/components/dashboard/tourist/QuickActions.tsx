...
const ACTIONS: Action[] = [
  {
    ...
    icon: Search,
    accent: "bg-teal-500/10 text-teal-600 group-hover:bg-teal-500 group-hover:text-white",
  },
  {
    label: "Plan New Trip",
  ...
  },
  {
    ...
    icon: BookOpen,
    accent: "bg-violet-500/10 text-violet-600 group-hover:bg-violet-500 group-hover:text-white",
  },
  {
    label: "Reviews",
  ...
  },
  {
    ...
    icon: Bell,
    accent: "bg-rose-500/10 text-rose-600 group-hover:bg-rose-500 group-hover:text-white",
  },
];
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-3">
        {ACTIONS.map(({ label, description, href, icon: Icon, accent }) => (
          <Link
            ...
            className="group flex flex-col gap-2 rounded-xl border border-border/60 p-3 transition-all duration-300 hover:-translate-y-0.5 hover:border-teal-500/40 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2"
          >
            <span
              aria-hidden="true"
              className={cn(
